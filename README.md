...
- Ubuntu Server 26.04 LTS (Resolute) installed on the Pi's SD card.
...
| `firewall_ansible_bootstrap_directory` | `/root/.ansible/pull/bootstrap` | Separate checkout used to bootstrap Ansible collection dependencies. |
